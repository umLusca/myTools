window.FontAwesomeKitConfig = {
	...
	try {
		if (window.FontAwesomeKitConfig) {
			var k = window.FontAwesomeKitConfig, L = {
				...
				document: document
			}, I = document.currentScript, T = I ? I.parentElement : document.head;
			(function () {
				...
				}(t, e) : "css" === t.method ? C(t, e, function (t) {
					U(t), function (t) {
				...
				t.map(function (t) {
					try {
						T.insertBefore(t, I ? I.nextSibling : null)
					} catch (e) {
						T.appendChild(t)
					}
				}), L.detectingConflicts && I && U(function () {
					I.setAttributeNode(document.createAttribute(L.detectionIgnoreAttr));
					var t = function (t, e) {
