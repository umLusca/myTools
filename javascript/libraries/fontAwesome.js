    ...
    window.FontAwesomeKitConfig = {
        ...
        minify: {enabled: !1},
        token: "dd7b63f2bb",
        v4FontFaceShim: {enabled: !1},
        v4shim: {enabled: !1},
        v5FontFaceShim: {enabled: !1},
        version: "6.6.0"
    }, function (t) {
        ...
        var u, f = function () {
            ...
            d = "undefined" == typeof setImmediate ? setTimeout : setImmediate, l = [];
        ...
        function E(t, e) {
            ...
            return "URLSearchParams" in window ? (i = new URL(t)).searchParams.set("token", r) : i = i + "?token=" + encodeURIComponent(r), i = i.toString(), new F((function (t, e) {
        ...
        try {
            if (window.FontAwesomeKitConfig) {
                var U = window.FontAwesomeKitConfig, k = {
                    detectingConflicts: U.detectConflictsUntil && new Date <= new Date(U.detectConflictsUntil),
                    detectionIgnoreAttr: "data-fa-detection-ignore",
                    fetch: window.fetch,
                    token: U.token,
                    XMLHttpRequest: window.XMLHttpRequest,
                    document: document
                }, L = document.currentScript, I = L ? L.parentElement : document.head;
                (function () {
                    ...
                    return "js" === t.method ? function (t, e) {
                        ...
                        var n = [];
                        return t.v4shim.enabled && n.push(new F((function (n, r) {
                            E(c(t, {addOn: "-v4-shims", minify: t.minify.enabled}), e).then((function (t) {
                                n(C(t, o(o({}, e), {}, {id: "fa-v4-shims"})))
                            })).catch(r)
                        }))), n.push(new F((function (n, r) {
                            E(c(t, {minify: t.minify.enabled}), e).then((function (t) {
                                var r = C(t, o(o({}, e), {}, {id: "fa-main"}));
                                n(function (t, e) {
                    ...
                    }(t, e) : "css" === t.method ? function (t, e) {
                        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : function () {
                            }, r = e.document || r, i = a.bind(a, r, ["fa", "fab", "fas", "far", "fal", "fad", "fak"]),
                            u = Object.keys(t.iconUploads || {}).length > 0;
                        t.autoA11y.enabled && n(i);
                        var f = [{id: "fa-main", addOn: void 0}];
                        t.v4shim && t.v4shim.enabled && f.push({
                            id: "fa-v4-shims",
                            addOn: "-v4-shims"
                            ...
                            id: "fa-v4-font-face",
                            addOn: "-v4-font-face"
                        }), u && f.push({id: "fa-kit-upload", customCss: !0});
                        var s = f.map((function (n) {
                            return new F((function (r, i) {
                                E(n.customCss ? function (t) {
                                    return t.baseUrlKit + "/" + t.token + "/" + t.id + "/kit-upload.css"
                                }(t) : c(t, {addOn: n.addOn, minify: t.minify.enabled}), e).then((function (i) {
                                    r(function (t, e) {
                    ...
                    t.map((function (t) {
                        try {
                            I.insertBefore(t, L ? L.nextSibling : null)
                        } catch (e) {
                            I.appendChild(t)
                        }
                    })), k.detectingConflicts && L && P((function () {
                        L.setAttributeNode(document.createAttribute(k.detectionIgnoreAttr));
                        var t = function (t, e) {
